...
var centerMenu = [
    ...
    ,{
        name: '案知库收藏',
        url: '../anzhikuCollection/list.html'
    }
...
var adminurl =  "http://localhost:8080/rencaiguanliyuceping/admin/dist/index.html#/login";
