...
import center from '@/views/center'
    ...
    import anzhiku from '@/views/modules/anzhiku/list'
    import anzhikuCollection from '@/views/modules/anzhikuCollection/list'
    import anzhikuLiuyan from '@/views/modules/anzhikuLiuyan/list'
    ...
    import dictionaryAnzhiku from '@/views/modules/dictionaryAnzhiku/list'
    import dictionaryAnzhikuCollection from '@/views/modules/dictionaryAnzhikuCollection/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryAnzhiku',
        name: '案知库类型',
        component: dictionaryAnzhiku
    }
    ,{
        path: '/dictionaryAnzhikuCollection',
        name: '收藏表类型',
        component: dictionaryAnzhikuCollection
    }
    ,{
    ...
    ,{
        path: '/anzhikuCollection',
        name: '案知库收藏',
        component: anzhikuCollection
      }
    ,{
        path: '/anzhikuLiuyan',
        name: '案知库留言',
        component: anzhikuLiuyan
      }
    ,{
        path: '/dictionary',
        name: '字典',
