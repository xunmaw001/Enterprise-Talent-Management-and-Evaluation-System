...
public class AnzhikuCollectionView extends AnzhikuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String anzhikuCollectionValue;
	...
	public AnzhikuCollectionView() {

	}

	public AnzhikuCollectionView(AnzhikuCollectionEntity anzhikuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, anzhikuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getAnzhikuCollectionValue() {
				return anzhikuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setAnzhikuCollectionValue(String anzhikuCollectionValue) {
				this.anzhikuCollectionValue = anzhikuCollectionValue;
			}
